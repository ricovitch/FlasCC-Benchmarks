...
static AS3_Val bench_accumulate(void* self, AS3_Val args)
{	
	...
	printf("C++ benchmarks 'simple_types_constant_folding (bench_accumulate)' with args : %d - %d\n", iterations, init_value);
...
static AS3_Val bench_insertion_sort(void* self, AS3_Val args)
{	
	// output command for documentation:
	int i;
	double dZero = 0.0;
	...
	DoubleValueWrapper10 DV10Zero = DoubleValueWrapper10(0.0);
	AS3_ArrayValue(args,"IntType, FloatType", &iterations, &init_value);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_insertion_sort)' with args : %d - %d\n", iterations, init_value);
...
static AS3_Val bench_quicksort(void* self, AS3_Val args)
{	
	// output command for documentation:
	int i;
	double dZero = 0.0;
	...
	DoubleValueWrapper10 DV10Zero = DoubleValueWrapper10(0.0);
	AS3_ArrayValue(args,"IntType, FloatType", &iterations, &init_value);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_quicksort)' with args : %d - %d\n", iterations, init_value);
...
static AS3_Val bench_heap_sort(void* self, AS3_Val args)
{	
	// output command for documentation:
	int i;
	double dZero = 0.0;
	...
	DoubleValueWrapper10 DV10Zero = DoubleValueWrapper10(0.0);
	AS3_ArrayValue(args,"IntType, FloatType", &iterations, &init_value);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_heap_sort)' with args : %d - %d\n", iterations, init_value);
...
int main()
{
	AS3_Val bench_accumulateMethod = AS3_Function(NULL, bench_accumulate);
	AS3_Val bench_insertion_sortMethod = AS3_Function(NULL, bench_insertion_sort);
	AS3_Val bench_quicksortMethod = AS3_Function(NULL, bench_quicksort);
	AS3_Val bench_heap_sortMethod = AS3_Function(NULL, bench_heap_sort);
	
	AS3_Val result = AS3_Object("bench_accumulate: AS3ValType,\
				bench_insertion_sort: AS3ValType,\
				bench_quicksort: AS3ValType,\
				bench_heap_sort: AS3ValType",
				bench_accumulateMethod, bench_insertion_sortMethod, bench_quicksortMethod, bench_heap_sortMethod);
				
	AS3_Release (bench_accumulateMethod);
	AS3_Release (bench_insertion_sortMethod);
	AS3_Release (bench_quicksortMethod);
	AS3_Release (bench_heap_sortMethod);
