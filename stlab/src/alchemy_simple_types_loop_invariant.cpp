...
{	
	...
	int i;
	double temp = 1.0;
	AS3_ArrayValue(args,"IntType, FloatType, FloatType", &iterations, &init_value, &temp);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_int8_t)' with args : %d - %d - %d\n", iterations, init_value, temp);
...
{	
	...
	double temp = 1.0;
	AS3_ArrayValue(args,"IntType, FloatType, FloatType", &iterations, &init_value, &temp);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_uint8_t)' with args : %d - %d - %d\n", iterations, init_value, temp);
...
{	
	...
	double temp = 1.0;
	AS3_ArrayValue(args,"IntType, FloatType, FloatType", &iterations, &init_value, &temp);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_int16_t)' with args : %d - %d - %d\n", iterations, init_value, temp);
...
{	
	...
	double temp = 1.0;
	AS3_ArrayValue(args,"IntType, FloatType, FloatType", &iterations, &init_value, &temp);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_uint16_t)' with args : %d - %d - %d\n", iterations, init_value, temp);
...
{	
	...
	double temp = 1.0;
	AS3_ArrayValue(args,"IntType, FloatType, FloatType", &iterations, &init_value, &temp);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_int32_t)' with args : %d - %d - %d\n", iterations, init_value, temp);
...
{	
	...
	double temp = 1.0;
	AS3_ArrayValue(args,"IntType, FloatType, FloatType", &iterations, &init_value, &temp);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_uint32_t)' with args : %d - %d - %d\n", iterations, init_value, temp);
...
{	
	...
	double temp = 1.0;
	AS3_ArrayValue(args,"IntType, FloatType, FloatType", &iterations, &init_value, &temp);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_int64_t)' with args : %d - %d - %d\n", iterations, init_value, temp);	
...
{	
	...
	double temp = 1.0;
	AS3_ArrayValue(args,"IntType, FloatType, FloatType", &iterations, &init_value, &temp);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_uint64_t)' with args : %d - %d - %d\n", iterations, init_value, temp);	
...
{	
	...
	double temp = 1.0;
	AS3_ArrayValue(args,"IntType, FloatType, FloatType", &iterations, &init_value, &temp);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_float)' with args : %d - %d - %d\n", iterations, init_value, temp);	
...
{	
	...
	double temp = 1.0;
	AS3_ArrayValue(args,"IntType, FloatType, FloatType", &iterations, &init_value, &temp);
	printf("C++ benchmarks 'simple_types_constant_folding (bench_double)' with args : %d - %d - %d\n", iterations, init_value, temp);	
